create   PROCEDURE [dbo].[ApplyPoints_28Jun23]   
(  
...
BEGIN  
 ...
 DECLARE @punchPromotionId NVARCHAR(10)='',@punchTrxId Int,@isPunch smallint=0;
...
------------------------------------------------------*/
 ...
 BEGIN
 exec [StampCardManualClaim] @punchTrxId,@punchPromotionId,@Quantity,@Quantity,@ClientId,@ChangeBy
 INSERT INTO [Audit] ([Version], UserId, FieldName, NewValue,OldValue,ChangeDate,ChangeBy,Reason,ReferenceType,OperatorId,SiteId)  
