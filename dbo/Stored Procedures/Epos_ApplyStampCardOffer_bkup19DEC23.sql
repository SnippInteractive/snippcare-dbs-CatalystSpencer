...
-- =============================================
create PROCEDURE [dbo].[Epos_ApplyStampCardOffer_bkup19DEC23]
...
BEGIN
	...
	SELECT TrxId,TrxDetailId,LineNumber,Points,BonusPoints,Value,0,0 FROM TrxDetail  with(nolock) Where TrxId = @TrxId
