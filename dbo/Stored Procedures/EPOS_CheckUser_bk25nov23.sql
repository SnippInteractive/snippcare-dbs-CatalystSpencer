...
-- =============================================
create PROCEDURE [dbo].[EPOS_CheckUser_bk25nov23](@ClientId int,@SourceAddress nvarchar(50))
AS
BEGIN
	...
	BEGIN
	   ...
	   SET @message = 'Unregistered'
		...
		BEGIN
			...
			IF NOT EXISTS (SELECT 1 FROM TrxHeader  Where DeviceId  = @DeviceId AND TrxStatusTypeId = @TrxStatusCompletedId AND TrxTypeId=@TrxTypeId)
			BEGIN
