CREATE TABLE [dbo].[Promotion] (
    ...
    [MisCode]                         NVARCHAR (50)   COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
    ...
    [CriteriaId]                      INT             NULL,
    [Cumulation]                      INT             NULL,
    [Reward]                          NVARCHAR (150)  NULL,
    [ActivityTypeId]                  INT             NULL,
    [ActivityReference]               NVARCHAR (300)  NULL,
    [ActivityCategoryId]              INT             NULL,
    [ActivityCategoryTypeId]          INT             NULL,
    [ImageName]                       NVARCHAR (100)  NULL,
    [ImageUrl]                        NVARCHAR (1000) NULL,
    [ActivityConfiguration]           NVARCHAR (MAX)  NULL,
    ...
    CONSTRAINT [FK_TimeZoneId] FOREIGN KEY ([TimeZoneId]) REFERENCES [dbo].[TimeZone] ([Id]),
