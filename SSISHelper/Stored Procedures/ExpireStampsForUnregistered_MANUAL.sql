...
CREATE Procedure [SSISHelper].[ExpireStampsForUnregistered_MANUAL] (@ExpireStampsForUnregistered int=45, @ClientId INT = 1) as 
/*
...
Begin
	...
	AND CONVERT(date,TrxDate) = '2024-05-04'
	--AND th.TrxId > 17310335
	...
	--SELECT DISTINCT CONVERT(date,TrxDate) FROM #TrxFullData
	--SELECT * FROM #TrxData
	--SELECT * FROM #RomoveDataIFNoEarnedStamps
