...
CREATE Procedure [SSISHelper].[NotificationsRegistered_WIP] (
...
Begin
	...
	Begin
		...
		SELECT * FROM NotificationsToSend where NotificationType='SMS' and  JSON_Value ( JSON_query(contactpreferences, '$.Notifications[2].Scenarios[0].Notifications'),'$.SMS' ) ='false'
